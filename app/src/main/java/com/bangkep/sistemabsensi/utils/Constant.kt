...
object Constant {
    ...
    const val reffGetDataPegawai = "getDataPegawai"
    const val reffGetDataAdmin = "getDataAdmin"
    ...
    const val reffUpdateAbsensiStatus = "updateAbsensiStatus"
...
//    const val defaultTempFoto = "https://sistemabsensi.tahirkun.asia/assets/img/absensi/unlike.png"
    ...
    const val belumAbsen = "Belum Absensi"
    const val sudahAbsen = "Sudah Absensi"
    ...
    const val noRequest = "Maaf, belum ada permintaan verifikasi"
